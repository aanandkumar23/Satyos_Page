...
const Hero = () => {
  return (
    ...
    >
      ...
      <div className="absolute  inset-0 bg-black pt-6  bg-opacity-40"></div>

      <div className="relative z-10 font-madefor  text-left pl-4 sm:pl-6 max-w-fit space-y-3">
        <span className="text-white lg;block sm:inline lg:px-4 pb-3 text-xl sm:text-[20.67px] md:text-[41.533px] lg:text-[43px] font-normal leading-snug">
          Welcome to Satyos Solutions, your one-stop
        </span>
        <span className="text-white lg:block sm:inline  lg:px-4 pb-3 text-xl sm:text-xl md:text-4xl lg:text-[43px] font-normal leading-snug">
          destination for innovative mobile and web
        </span>
        <span className="text-white lg:block sm:inline  lg:px-4 pb-3 text-xl sm:text-3xl md:text-4xl lg:text-[43px] font-normal leading-snug">
