...
const About = () => {
  ...
  return (
    <section id="about" className="py-24 bg-white">
      ...
      <h2 className="  font-madefor text-[28px] md:text-[100px] font-semibold pl-4 w-full ">
      ...
      <div className="max-w-7xl mx-auto  px-4 sm:px-6 lg:px-8 text-center mb-16">
        ...
        <h3 className="font-madefor text-3xl md:text-4xl lg:text-[57.03px] font-semibold text-black pt-52 mt-4 mb-4">Our Services</h3>
        <p className="font-madefor text-lg py-4 text-gray-800 lg:text-[16px] max-w-4xl mx-auto">
      ...
      <div style={{ backgroundColor: '#FFFFFF' }} className="text-black">
        ...
        <h2 className="text-[57.03px] font-madefor font-semibold text-center text-gray-900 mb-12">Client Testimonials</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 justify-evenly">
          <div className="text-center">
            <p className="text-gray-700 mb-4 font-madefor text-[16px]">
              The team at Satyos Solutions is <br/>
              highly skilled and dedicated to <br/>
              delivering top-quality results.
            </p>
            <h4 className="text-[16px] font-madefor pt-10 pb-2 font-semibold text-gray-900">Ajay Kamath</h4>
          ...
          <div className="text-center">
            ...
            <h4 className="text-[16px] font-madefor pt-10 pb-2 font-semibold text-gray-900">David Brown</h4>
          ...
          <div className="text-center">
            ...
            <h4 className="text-[16px] font-madefor pt-10 pb-2 font-semibold text-gray-900">Rajan Malik</h4>
          ...
          <div className="text-center">
            ...
            <h4 className="text-[16px] font-madefor pt-10 pb-2 font-semibold text-gray-900">Deep Parmar</h4>
